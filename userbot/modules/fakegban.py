...
async def gbun(event):
    ...
    gbunVar = event.text
    gbunVar = gbunVar[6:]
    mentions = f"`Warning!! User Berhasil Di Banned Oleh` {DEFAULTUSER}\n"
    no_reason = "No Reason Given "
    await event.edit("**Kicking........️**")
    asyncio.sleep(5)
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1036951071:
            ...
            jnl=("`Warning!!`"
                  "[{}](tg://user?id={})"
                  f"` Berhasil Di Banned Oleh` {DEFAULTUSER}\n\n"
                  "**Name: ** __{}__\n"
                  "**ID : ** `{}`\n"
        ...
        mention = (f"Warning!! User Berhasil Di Banned Oleh {DEFAULTUSER} \nReason: No Reason Given. ")
